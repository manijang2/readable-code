...
public class GameBoard {
    ...
    public void openSurrondedCells(int row, int col) {
        ...
        findCell(row, col).open();

        if (doesCellHaveLandMineCount(row, col)) {
            return;
        }

        openSurrondedCells(row - 1, col - 1);
        openSurrondedCells(row - 1, col);
        openSurrondedCells(row - 1, col + 1);
        openSurrondedCells(row, col - 1);
        openSurrondedCells(row, col + 1);
        openSurrondedCells(row + 1, col - 1);
        openSurrondedCells(row + 1, col);
        openSurrondedCells(row + 1, col + 1);
