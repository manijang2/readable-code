...
public class MinesweeperGame {
    ...
    private static void actOnCell(String cellInput, String userActionInput) {
        ...
        throw new AppException("잘 못된 번호를 선택했습니다.");
    }
    ...
    private static boolean doesUserChooseToPalntFlag(String userActionInput) {
    ...
    private static int convertRowFrom(char cellInputRow) {
        ...
        if (rowIndex >= BOARD_ROW_SIZE) {
            throw new AppException("잘 못된 입력입니다.");
        }
        return rowIndex;
    }
    ...
    private static int convertColFrom(char cellInputCol) {
        switch (cellInputCol) {
            ...
            case 'j':
                return 9;
            default:
                throw new AppException("잘 못된 입렵입니다.");
        }
    }
