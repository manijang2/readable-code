...
public class StudyCafePassMachine {
    ...
    private final SeatLockerProvider seatLockerProvider;

    public StudyCafePassMachine(SeatPassProvider seatPassProvider, SeatLockerProvider seatLockerProvider) {
        this.seatPassProvider = seatPassProvider;
        this.seatLockerProvider = seatLockerProvider;
    }
    ...
    private Optional<StudyCafeLockerPass> findLockerPassCandidateBy(StudyCafeSeatPass pass) {
        StudyCafeLockerPasses allLockerPasses = seatLockerProvider.getLockerPasses();
